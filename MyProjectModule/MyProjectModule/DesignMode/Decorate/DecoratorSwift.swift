//
//  DecoratorSwift.swift
//  MyProjectModule
//
//  Created by zhangxinxin on 2021/3/2.
...
/**
 装饰器模式:
 1.  不改变对象接口的前提下强化对象功能。
 2.  就功能而言，修饰模式相比生成子类更为灵活，这样可以给某个对象而不是整个类添加一些功能。
 3.  这个还是需要对被装饰的类进行改动：声明一套协议
...
class DecoratorConceptual: NSObject {
