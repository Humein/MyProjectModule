...
/*
 ...
 3: 抽象组合(使用协议代替继承 可以更好的实现功能(组建)的 插拔性) -----  ShakeView  [Swift面向协议编程(POP)](https://juejin.im/post/5d68c722f265da03a0498e0c)
     [Swift 中的面向协议编程：引言](https://swift.gg/2019/09/05/protocol-oriented-programming/)
 
      我们经常会遇到如下场景: 假设我们有一个ViewController，它继承自UIViewController，我们向其新添加一个方法 customMethod：
