...
#import "UIView+ChainFrameView.h"
#import "UIButton+SegementCustomButton.h"
...
@implementation SegementTitleView

- (instancetype)initWithFrame:(CGRect)frame delegate:(id<SGPageTitleViewDelegate>)delegate titleNames:(NSArray *)titleNames configure:(SegementTitleConfigured *)configure {
...
+ (instancetype)pageTitleViewWithFrame:(CGRect)frame delegate:(id<SGPageTitleViewDelegate>)delegate titleNames:(NSArray *)titleNames configure:(SegementTitleConfigured *)configure {
